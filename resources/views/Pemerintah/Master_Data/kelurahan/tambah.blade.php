...
<main class="p-4 sm:ml-64 mt-10">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        <h2 class="text-2xl font-bold text-center mb-4">Tambah Data Kelurahan</h2>
        ...
        <form action="{{ route('pemerintah.master_data.kelurahan.store') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div>
                    <label for="kelurahan" class="block text-sm font-medium text-gray-700">Nama Kelurahan</label>
                    <input type="text" id="kelurahan" name="kelurahan" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                </div>

                <!-- Dropdown Kecamatan -->
                <div>
                    <label for="kecamatan_id" class="block text-sm font-medium text-gray-700">Pilih Kecamatan</label>
