...
<main class="p-4 sm:ml-64 mt-10">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        <h2 class="text-2xl font-bold text-center mb-4">Tambah Data Petugas</h2>
        ...
        <form action="{{ route('pemerintah.master_data.tambah-petugas.submit') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
            @csrf
            <div class="grid grid-cols-1 gap-1">
                ...
                <div>
                    ...
                    <input type="number" id="petugas" name="petugas" class="mt-1 block w-auto border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                </div>               
                <!-- Kecamatan -->
                <div class="mb-4">
