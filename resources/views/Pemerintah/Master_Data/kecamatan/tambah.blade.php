...
<main class="p-4 sm:ml-64 mt-10">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        <h2 class="text-2xl font-bold text-center mb-4">Tambah Data Kecamatan</h2>
        ...
        <form action="{{ route('pemerintah.master_data.tambah-kecamatan.submit') }}" method="POST" class="space-y-4">
            @csrf
