...
<main class="p-4 sm:ml-64 mt-10">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        <h2 class="text-2xl font-bold text-center mb-4">LAPORAN PENGANGKUTAN DARURAT</h2>
        ...
        @endif
            <div class="bg-gray-50 p-4 rounded-md border border-gray-300 space-y-2">
                <input type="hidden" id="pengangkutan_darurat_id" name="pengangkutan_darurat_id" value="{{ $pengangkutanDarurat->id }}" required>
            ...
            <form action="{{ route('petugas.laporan-darurat.submit') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="pengangkutan_darurat_id" value="{{ $pengangkutanDarurat->id }}">
            <!-- Catatan -->
            <div>
